...
<div class="card card-info">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-flag"></i> Profil Kelas X PPLG 2</h3>
	</div>
...
<?php
	...
	$sql = $koneksi->query("SELECT count(nip) as lokal from tb_mahasiswa");
...
<?php
	$sql = $koneksi->query("SELECT count(nip) as putra from tb_mahasiswa where status='mahasiswa'");
	while ($data= $sql->fetch_assoc()) {
...
<?php
	$sql = $koneksi->query("SELECT count(nip) as putri from tb_mahasiswa where status='Honorer'");
	while ($data= $sql->fetch_assoc()) {
...
<div class="row">
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-primary">
			...
			<a href="?page=data-mahasiswa" class="small-box-footer">Selengkapnya
	...
	<div class="col-lg-3 col-6">
		...
		<div class="small-box bg-success">
			...
			<a href="https://www.instagram.com/rpl2_2025/" class="small-box-footer">Informasi
			</a>
		</div>
	</div>
	<!-- ./col -->
